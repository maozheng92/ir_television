...
class ResolveCommandTests(unittest.TestCase):
    ...
    def test_single_power_button_uses_tv_state(self) -> None:
        on_off = {"turn_on": _ir("on"), "turn_off": _ir("off")}
        self.assertEqual(actions.resolve_power_press_key(on_off, is_on=False), "turn_on")
        self.assertEqual(actions.resolve_power_press_key(on_off, is_on=True), "turn_off")
        toggle = {"power_toggle": _ir("pwr")}
        self.assertEqual(actions.resolve_power_press_key(toggle, is_on=False), "power_toggle")
        self.assertEqual(actions.resolve_power_press_key(toggle, is_on=True), "power_toggle")
        both = {"turn_on": _ir("on"), "turn_off": _ir("off"), "power_toggle": _ir("pwr")}
        self.assertEqual(actions.resolve_power_press_key(both, is_on=False), "turn_on")
        self.assertEqual(actions.resolve_power_press_key(both, is_on=True), "turn_off")
        self.assertIsNone(actions.resolve_power_press_key({}, is_on=False))
